...
readarray -t visitas < ~/github/wiki-cachitos/wikipedia-data/s07e03/csv/visitas.csv

# Guardamos en un array el promedio de visitas
readarray -t promedio < ~/github/wiki-cachitos/wikipedia-data/s07e03/csv/mean.csv
